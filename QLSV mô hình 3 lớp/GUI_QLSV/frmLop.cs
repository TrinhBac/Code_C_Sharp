...
namespace GUI_QLSV
{
    public partial class frmLop : Form
    {
        ...
        private void dgvDSLOP_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dong > -1)
            {
                txtMaLop.Text = dgvDSLOP.Rows[dong].Cells[0].Value.ToString();
                txtTenLop.Text = dgvDSLOP.Rows[dong].Cells[1].Value.ToString();
                txtPhong.Text = dgvDSLOP.Rows[dong].Cells[2].Value.ToString();
            }
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Lỗi xóa", "Thong bao");
                }
            }
        }
